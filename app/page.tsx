                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                              ...
                              <div className="md:col-span-4">
                                ...
                                <input
                                  ...
                                  className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs text-gray-950 placeholder:text-gray-400 focus:border-black focus:outline-none dark:border-zinc-800 dark:bg-zinc-950 dark:text-neutral-100 transition-all"
